...
Clone the repository onto your local. Once done, on the terminal, navigate to the folder with the images you want to convert and run the following command:
